...
class Registradora_Caja:
    def __init__(self,Articulos,Total_Compra,sub_Total,Total_Precio,Stop):
    ...
    def Pedido_Cliente(self):
        ...
        Escaner_Producto =  Escaner([],[])
        while Stop!="-1":
            sys.stdout.flush() ; time.sleep(1) ; os.system ("cls")
            Menu.Inicio()
            ...
            if Producto_Cliente.Validar_P() !=True: Menu.Error_P() ; time.sleep(1)
                ...
                if Producto_Cliente.Validar_P() !=True: Menu.Error_P() ; time.sleep(1)
                    ...
                    if Producto_Cliente.Validar_P() !=True: Menu.Error_P() ; time.sleep(1)
                        ...
                        Producto_Cliente.Crear_Producto() ; Escaner_Producto =  Escaner(Sub_Total,Total_Compra)
                        Total_Precio = 0.0 ; Total_Precio = Escaner_Producto.Total_Pedido(Total_Precio)
...
if __name__ == "__main__":
    ...
    Registradora = Registradora_Caja([])
